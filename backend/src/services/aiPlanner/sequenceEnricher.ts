...
const KNOWN_PREREQ_CHAINS: Record<string, string[][]> = {
  '62510': [
    ['CITS1401', 'CITS4401'],
    ['CITS1401', 'CITS5505'],
    ['CITS1401', 'CITS4012'],
...
const KNOWN_SPECIALISATIONS: Record<string, SpecialisationInfo[]> = {
  '62510': [
    {
      code: 'SP-APCMP',
      name: 'Applied Computing',
      coreUnits: ['CITS4009', 'CITS4012', 'CITS4401', 'CITS5505'],
      electiveOptions: ['CITS4402', 'CITS4403', 'CITS4404', 'CITS4407', 'CITS5503', 'CITS5506', 'CITS5206', 'CITS5017'],
    ...
    },
    {
      ...
      electiveOptions: ['CITS4402', 'CITS4403', 'CITS4419', 'CITS5506'],
    ...
    },
    {
      ...
      electiveOptions: ['CITS4403', 'CITS4407', 'CITS4419', 'CITS4505', 'CITS5506', 'CITS5014'],
 ...
 */
function assignSequenceOrder(catalogue: ProgramCatalogue): void {
...
function computePrerequisiteDepth(
  code: string,
  unitMap: Map<string, { code: string; prerequisites: string[] }>,
  visited: Set<string>,
  depth: number,
): number {
  if (visited.has(code)) return depth;
  visited.add(code);
 ...
 */
function buildPrerequisiteChains(catalogue: ProgramCatalogue): string[][] {
...
function buildSequenceData(catalogue: ProgramCatalogue): { unitCode: string; recommendedSemester: string; notes: string }[] {
  const sequenceData: { unitCode: string; recommendedSemester: string; notes: string }[] = [];
 ...
 */
export async function EnhanceCatalogueWithSequenceData(
  catalogue: ProgramCatalogue,
): Promise<ProgramCatalogue> {
