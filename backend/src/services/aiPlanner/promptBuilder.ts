...
export function buildSystemPrompt(): string {
  return [
    ...
    '',
    '**💬 Layer 3 — SPECIFIC REQUESTS (BEST-EFFORT):** Explicit unit requests like "do research" (→ CITS5014/CITS5015), "take CITS5508", or named electives. These are NICE-TO-HAVE. If they conflict with Layer 1 or Layer 2 constraints (availability, prerequisites, slot limits), DROP them and add a warning explaining why.',
    '',
    ...
    '',
    '**Resolution rule:** Layer 1 ALWAYS wins. Try to satisfy Layer 2 fully, then Layer 3 with remaining slots. If Layer 3 requests conflict with Layer 1 or Layer 2, sacrifice Layer 3 and warn. If Layer 2 conflicts with Layer 1, sacrifice Layer 2 and warn.',
    '',
    ...
    '',
    '**Step 3 — Check availability and slot limits**',
    'Count how many S1-only units compete for S1 2027 slots. If > 4, you have a conflict.',
    '',
    '**Step 4 — Apply priority layers**',
    'Layer 1 units FIRST (fill mandatory slots). Then Layer 2 (specialisation/broad interest). Then Layer 3 (specific requests) with remaining slots. Drop Layer 3 requests that can\'t fit.',
    '',
    ...
    'Verify EVERY unit: (1) offered this semester? (2) prereqs satisfied? (3) no incompatibilities? (4) max 4 per semester? Fix any violations.',
    '',
