...
exports.parseGroupRule = parseGroupRule;
...
function parse62510Rule(groupCode, ruleText) {
    ...
    if (["GROUP_A", "GROUP_B", "GROUP_C"].includes(groupCode) &&
        /total of 24 points from groups A, B and C/i.test(clean)) {
        const base = groupCode === "GROUP_A"
            ? {
                type: "POINTS_FROM_GROUP",
                group: "GROUP_A",
                value: 6,
...
function parse41680Rule(groupCode, ruleText) {
    const clean = normalizeText(ruleText);
...
function parseGroupRule(courseCode, groupCode, ruleText) {
    if (!courseCode || !ruleText)
        return null;
    if (courseCode === "62510") {
