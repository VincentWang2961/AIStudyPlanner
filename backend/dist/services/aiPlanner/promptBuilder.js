...
function buildSystemPrompt() {
    return [
        ...
        '⛔ **RESEARCH PAIR RULE (ABSOLUTE):** CITS5014 and CITS5015 are a BOUND PAIR. Either include BOTH (in consecutive semesters, 5014 before 5015) or include NEITHER. Before placing CITS5014, verify you have room for BOTH 5014 AND 5015. If not, do NOT place either — fill those slots with normal electives instead.',
        '',
        '## Reasoning Process',
        '',
