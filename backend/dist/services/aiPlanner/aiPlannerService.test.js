...
jest.mock('./planValidator', () => ({
    validateAiGeneratedPlan: jest.fn().mockResolvedValue({
        overallStatus: 'pass',
        issues: [{ category: 'validation', severity: 'pass', title: 'Basic validation passed', message: 'All checks passed.' }],
    }),
}));
...
const mockedGetMockProgrammeCatalogue = mockCatalogue_1.getMockProgrammeCatalogue;
describe('generateStudyPlan integration', () => {
    ...
    beforeEach(() => {
        ...
        mockedGetMockProgrammeCatalogue.mockImplementation((code) => {
            if (code === '62510') {
    ...
    it('should reject irrelevant prompts', async () => {
        await expect((0, aiPlannerService_1.generateStudyPlan)({
